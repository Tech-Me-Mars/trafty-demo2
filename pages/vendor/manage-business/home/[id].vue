<template>
    <div class="min-h-screen flex flex-col" style="background-color: #ffc83A;">
                ...
                <div class="flex space-x-3">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-2">
                            ...
                            <p v-if="resShop?.status == true"
                                class="bg-red-50 text-green-500 text-xs font-semibold px-2 py-1 rounded-md flex items-center space-x-1 inline-flex ">
                                <i class="fa-solid fa-circle-exclamation text-xs"></i>
        ...
        <div class="bg-yellow-100 p-4">
            <h2 class="text-black font-semibold">รายการของฉัน ({{ resShop?.business_lists?.length || 0 }})</h2>
        </div>
